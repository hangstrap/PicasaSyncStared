...
void main() {
  ...
  //neested function
  bool isYearDirectory( Directory entity){
...
void procesYearDirectory( Directory entity){
  ...
  new Directory( entity.path).listSync()
      .where( (e) => _isYyyymmDdDirectory(e) && containsPicasaIni( e))
        .forEach( (e)=>processDiretory(year, e));
}
...
token=test_2013
 */
void insureConfigContainsBestOfYearAlbum( String year, String albumToken, Config config){
